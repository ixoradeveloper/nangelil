...
function my_theme_register_required_plugins() 
{
	$plugins = array(
		...
		array(
			'name'     				=> __('CSS3 Compare Pricing Tables for WordPress', 'medicenter'), // The plugin name
			...
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '11.5', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
			'external_url' 			=> '', // If set, overrides default API URL and points to an external URL
		),
	...
	$config = array(
		...
		'strings'      		=> array(
			...
			'notice_ask_to_update' 						=> _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.  Please check update instructions <a href="https://support.quanticalabs.com/forum/topic/6423/faq-frequently-asked-questions#question_55">here</a>.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.  Please check update instructions <a href="https://support.quanticalabs.com/forum/topic/6423/faq-frequently-asked-questions#question_55">here</a>.', 'medicenter' ), // %1$s = plugin name(s)
